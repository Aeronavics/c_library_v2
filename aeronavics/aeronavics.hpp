...
/** @brief  */
enum class ANV_CONTROLLER : uint8_t
{
    GS_CONTROLLER=0, /* Premium Ground Station controls | */
    HAND_CONTROLLER_AIRCRAFT=1, /* Hand controller for aircraft controls | */
    HAND_CONTROLLER_PAYLOAD=2, /* Hand controller for payload controls | */
};

//! ANV_CONTROLLER ENUM_END
constexpr auto ANV_CONTROLLER_ENUM_END = 3;

/** @brief  */
enum class ANV_SPRAY_ERROR : uint8_t
{
    FLOWRATE1=1, /* Nozzle 1 has a flow rate error | */
    FLOWRATE2=2, /* Nozzle 2 has a flow rate error | */
    FLOWRATE3=4, /* Nozzle 3 has a flow rate error | */
    FLOWRATE4=8, /* Nozzle 4 has a flow rate error | */
    LOW_PRESSURE=16, /* Low pressure detected in spray system | */
    OVER_PRESSURE=32, /* Over pressure detected in spray system | */
    NO_SPRAY=64, /* No spray remaining or error with the spray measurement system | */
};

//! ANV_SPRAY_ERROR ENUM_END
constexpr auto ANV_SPRAY_ERROR_ENUM_END = 65;
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_anv_regulator_status.hpp"
#include "./mavlink_msg_anv_buffer_status.hpp"
#include "./mavlink_msg_anv_gsib_data.hpp"
#include "./mavlink_msg_anv_sbus_data.hpp"
#include "./mavlink_msg_anv_radio_data.hpp"
#include "./mavlink_msg_anv_firmware_information.hpp"
#include "./mavlink_msg_anv_gscb_data.hpp"
#include "./mavlink_msg_anv_latency_report.hpp"
#include "./mavlink_msg_anv_smart_port_poll_packet.hpp"
#include "./mavlink_msg_anv_gs_ctrl_data.hpp"
#include "./mavlink_msg_anv_gsmc_data.hpp"
#include "./mavlink_msg_anv_sysid.hpp"
#include "./mavlink_msg_anv_spray_status.hpp"
#include "./mavlink_msg_anv_tag_location.hpp"
