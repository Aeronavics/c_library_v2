#pragma once
// MESSAGE ANV_MSG_SPRAY_STATUS PACKING

#define MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS 5017
...
/**
 * @brief Pack a anv_msg_spray_status message
                               ...
                               uint16_t measured_flowrate, uint16_t desired_flowrate, double sprayed_volume, double spray_remaining, uint16_t pressure, uint8_t error)
{
    ...
    packet.error = error;
        ...
        memcpy(_MAV_PAYLOAD_NON_CONST(msg), &packet, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_LEN);
#endif

    msg->msgid = MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS;
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_MIN_LEN, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_LEN, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_CRC);
}
                               ...
                               uint16_t measured_flowrate, uint16_t desired_flowrate, double sprayed_volume, double spray_remaining, uint16_t pressure, uint8_t error)
{
    ...
    return mavlink_finalize_message_buffer(msg, system_id, component_id, _status, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_MIN_LEN, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_LEN, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_CRC);
#else
    return mavlink_finalize_message_buffer(msg, system_id, component_id, _status, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_MIN_LEN, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_LEN);
#endif
}

/**
 * @brief Pack a anv_msg_spray_status message on a channel
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
                                   ...
                                   uint16_t measured_flowrate,uint16_t desired_flowrate,double sprayed_volume,double spray_remaining,uint16_t pressure,uint8_t error)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_MIN_LEN, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_LEN, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_CRC);
}

/**
 * @brief Encode a anv_msg_spray_status struct
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 * @param anv_msg_spray_status C-struct to read the message contents from
 */
...
/**
 * @brief Encode a anv_msg_spray_status struct on a channel
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param chan The MAVLink channel this message will be sent over
...
/**
 * @brief Encode a anv_msg_spray_status struct with provided status structure
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param status MAVLink status structure
...
/**
 * @brief Send a anv_msg_spray_status message
...
static inline void mavlink_msg_anv_msg_spray_status_send(mavlink_channel_t chan, uint16_t measured_flowrate, uint16_t desired_flowrate, double sprayed_volume, double spray_remaining, uint16_t pressure, uint8_t error)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS, (const char *)&packet, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_MIN_LEN, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_LEN, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_CRC);
#endif
}
...
#if MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_LEN <= MAVLINK_MAX_PAYLOAD_LEN
/*
...
// MESSAGE ANV_MSG_SPRAY_STATUS UNPACKING


/**
 * @brief Get field measured_flowrate from anv_msg_spray_status message
 *
...
/**
 * @brief Get field desired_flowrate from anv_msg_spray_status message
 *
...
/**
 * @brief Get field spray_remaining from anv_msg_spray_status message
 *
...
/**
 * @brief Get field pressure from anv_msg_spray_status message
 *
...
/**
 * @brief Get field error from anv_msg_spray_status message
 *
 * @return  Spray Error
 */
...
/**
 * @brief Decode a anv_msg_spray_status message into a struct
 *
 * @param msg The message to decode
 * @param anv_msg_spray_status C-struct to decode the message contents into
 */
static inline void mavlink_msg_anv_msg_spray_status_decode(const mavlink_message_t* msg, mavlink_anv_msg_spray_status_t* anv_msg_spray_status)
{
    ...
    anv_msg_spray_status->pressure = mavlink_msg_anv_msg_spray_status_get_pressure(msg);
    anv_msg_spray_status->error = mavlink_msg_anv_msg_spray_status_get_error(msg);
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_LEN? msg->len : MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_LEN;
        memset(anv_msg_spray_status, 0, MAVLINK_MSG_ID_ANV_MSG_SPRAY_STATUS_LEN);
    memcpy(anv_msg_spray_status, _MAV_PAYLOAD(msg), len);
#endif
}
