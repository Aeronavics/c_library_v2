...
TEST(aeronavics, ANV_TAG_LOCATION)
{
    mavlink::mavlink_message_t msg;
    mavlink::MsgMap map1(msg);
    mavlink::MsgMap map2(msg);

    mavlink::aeronavics::msg::ANV_TAG_LOCATION packet_in{};
    packet_in.latitude = 963497464;
    packet_in.longitude = 963497672;

    mavlink::aeronavics::msg::ANV_TAG_LOCATION packet1{};
    mavlink::aeronavics::msg::ANV_TAG_LOCATION packet2{};
...
#ifdef TEST_INTEROP
TEST(aeronavics_interop, ANV_TAG_LOCATION)
{
    mavlink_message_t msg;
    ...
    mavlink_anv_tag_location_t packet_c {
         963497464, 963497672
    };
    ...
    mavlink_msg_anv_tag_location_encode(1, 1, &msg, &packet_c);
